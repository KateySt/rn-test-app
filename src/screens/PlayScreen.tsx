...
export default function PlayScreen() {
    ...
    const player = Matter.Bodies.rectangle(50, HEIGHT - 100, 50, 50, { label: 'Player' });
    ...
    return (
        <View style={styles.container}>
            <StatusBar hidden />
            <GameEngine
                systems={[Physics, (entities, args) => MoveObstacles(entities, args, onScoreIncrement), JumpSystem]}
                entities={{
